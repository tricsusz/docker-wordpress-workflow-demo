 ...
 *
 * Fichier listerPagesRestreintes.class.php
 */
...
class ListerPagesRestreintesAction extends AbstractAction {
	...
	public function execute() {
		...
		$this->setTemplate('pagesRestreintes/listerPagesRestreintes.php');
	}
