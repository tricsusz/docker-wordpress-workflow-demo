...
<table class="form-table">
	...
	<tr valign="top" id="form_advancedToolbar" <?php if( '2' == get_option('wpAppbox_defaultButton') ) echo 'style="display:none;"'; ?>>
...
<table id="table_buttons_settings" class="form-table" <?php if( '3' != get_option('wpAppbox_defaultButton') ) echo 'style="display:none;"'; ?>>
