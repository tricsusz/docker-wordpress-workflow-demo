...
<div style="position: relative;width:100%; top: 10px; height: auto; text-align: center; background-color:#f5d6a9;">
	...
	<div class="donation-link amazon"><a href="<?php echo( WPAPPBOX_URL_AMAZON ); ?>" target="_blank">Amazon</a></div>
	<div class="donation-link paypal"><a href="<?php echo( WPAPPBOX_URL_PAYPAL ); ?>" target="_blank">PayPal</a></div>
...
<small>
	<?php  
		...
		if ( $countCachedApps > 0 )
			echo( '<a href="options-general.php?page=wp-appbox&amp;tab=cache-list">' . $countCachedApps . '</a> ' . _n( 'app in cache', 'apps in cache', $countCachedApps, 'wp-appbox' ) . ' | ' );
	?>
...
<?php if ( isset( $_GET['showerrorlog'] ) ): ?>
	...
	<textarea id="wpappbox-error-log" style="font-family: monospace; width: 100%; height: 400px; white-space: pre;"><?php include( 'settings-errorlog.php' ); ?></textarea>
<?php endif; ?>