...
<table class="form-table ">
	...
	<tr valign="top">
		...
		<td colspan="7">
			...
			<br /><br />
			<img id="wpAppbox_bannerPreview" src="<?php echo( plugins_url( 'img/admin-previews/banner-' . $wpAppbox_styleNames[get_option('wpAppbox_defaultStyle')] . '.jpg', dirname( __FILE__ ) ) ); ?>" style="width:350px;" />
			<script>
				jQuery( "#wpAppbox_defaultStyle" ).change(function() {
					value = jQuery(this).val();
					<?php
						foreach ( $wpAppbox_styleNames as $styleID => $styleName ) {
							echo( "value$styleID = '" . plugins_url( 'img/admin-previews/banner-' . $styleName . '.jpg', dirname( __FILE__ ) ) ) . "';";
						}
					?>
	...
	<tr valign="top">
		...
		<td colspan="7">
			...
			?>
			<img id="wpAppbox_ratingstarsPreview" src="<?php echo( plugins_url( 'img/admin-previews/rating-stars-' . $previewOnload . '.jpg', dirname( __FILE__ ) ) ); ?>" style="width:350px;" />
			<script>
				jQuery( "#wpAppbox_showRating" ).change(function() {
					...
					<?php
						echo( "valuemonochrome = '" . plugins_url( 'img/admin-previews/rating-stars-monochrome.jpg', dirname( __FILE__ ) ) ) . "';";
						echo( "valuecolorful = '" . plugins_url( 'img/admin-previews/rating-stars-colorful.jpg', dirname( __FILE__ ) ) ) . "';";
						echo( "valuehidden = '" . plugins_url( 'img/admin-previews/rating-stars-hidden.jpg', dirname( __FILE__ ) ) ) . "';";
					?>
