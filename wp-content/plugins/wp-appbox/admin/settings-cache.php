	...
	<tr valign="top">
		...
		<td>
			<select name="wpAppbox_cacheMode" id="wpAppbox_cacheMode" class="postform">
				...
				<?php if( !defined( 'DISABLE_WP_CRON') || DISABLE_WP_CRON != true ): ?><option <?php selected( get_option('wpAppbox_cacheMode'), 'cronjob' ); ?> class="level-0" value="cronjob"><?php esc_html_e('Update automatically via Cronjob and manually', 'wp-appbox'); ?> (<?php esc_html_e('Experimental', 'wp-appbox'); ?>)</option><?php endif; ?>
			</select>
