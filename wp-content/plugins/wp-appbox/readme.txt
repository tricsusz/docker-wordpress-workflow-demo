...
Tags: google play, google, android, apps, apple, app store, ios, windows, mobile, windows store, appbox, firefox, chrome, chrome web store, amazon, amazon apps, wordpress, opera, steam, phg, gog.com, good old games, xda labs, affiliate
...
* Nutzung der PartnerNet-/Associates-ID für Amazon Apps
* Nutzung des Microsoft Private Affiliate Program via Impact
...
* Deutsch (Ich :-P)
* French (by Laurent)
* český (by (http://svetandroida.cz "Tomáš"))
...
= 4.1.0 =
* Gutenberg-Block für WP-Appbox implementiert
* Fehlerbeseitigung
...
= 4.0.62 =
* Apple Affiliate für den (Mac) App Store entfernt :-/
* Fehlerbeseitigung
...
= 4.0.47 =
* QR-Code kann auf dem eigenen Server gecached werden (EU-DSGVO/GDPR)
* Fehlerbeseitigung
...
= 4.0.45 =
* Externe Bilder über eigenen Bilder-Proxy laden (EU-DSGVO/GDPR)

= 4.0.43 - 4.0.44 =
* Fehlerbeseitigung

= 4.0.42 =
* Das Stylesheet lässt sich nur auf Beiträgen und Seiten einbinden

= 4.0.41 =
* Anzeige "Pre-register" für Google Play
* Fehlerbeseitigung

= 4.0.39 - 4.0.40 =
* Fehlerbeseitigung für Google Play (Dank an [AndroidPolice](https://www.androidpolice.com/2018/03/16/google-rolling-new-web-play-store-design-much-larger-screenshots-new-reviews-page/ "AndroidPolice") für die Daten!)

= 4.0.37 - 4.0.38 =
* Fehlerbeseitigung

= 4.0.36 =
* Änderung der URL für Steam-Abfragen

= 4.0.32 - 4.0.35 =
* Fehlerbeseitigung

= 4.0.31 =
* Apple App Store: "preorder" CSS-Klasse
* Apple App Store: Screenshot-Fix
* Opera Addons: Icon-Workaround
* Einstellungen: Mehr Resetmöglichkeiten im Advanced-Tab
...
= 4.0.29 =
* Fix für den neuen Apple App Store

= 4.0.28 =
* Fix für Amazon-Apps aus dem Google Play Store
* Fix für PHP 5.3

= 4.0.27 =
* Fix für Google Play URLs
...
= 4.0.17 =
* Fix für Google Play (Thank you Artem!)

= 4.0.16 =
* Fix für XDA Labs
* Fix für Server mit iPv6
* Neues Icon für den Apple App Store
* Neues Icon für Firefox Addons
* Korrektur kleinerer Fehler

= 4.0.15 =
* Automatische Erkennung für Amazon-URLs verbessert
* Screenshots für Watch-Apps
* Screenshots für iMessage-Apps
