...
* Amazon App Shop (Android & Alexa Skills)
...
* Use of the PartnerNet-/Associates-ID for Amazon Android Apps and Alexa Skills
...
A first implementation is available. However, this is experimental in nature and is not officially supported.
...
= 4.0.39 - 4.0.40 =
* Fixed: Various bugs for Google Play (Dank an [AndroidPolice](https://www.androidpolice.com/2018/03/16/google-rolling-new-web-play-store-design-much-larger-screenshots-new-reviews-page/ "AndroidPolice") for data!)
