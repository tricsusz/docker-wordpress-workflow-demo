...
<?php echo "<h2>" . sprintf( __( 'Startup Options', 'startup' ) ) . "</h2>"; ?>
...
<label class="description" for="startup_options[slider]"><?php _e( 'Universal Slider', 'startup' ); ?> <em>(<?php printf(__( 'important: you must create a slider first after installing %1$s WP Nivo Slider %2$s - for best results set slider to and prepare images at 1000px wide [or whatever you have set your max display width to] and 200px high - all slides need to be consistent in size - set category to pull featured images from in plugin settings', 'startup' ), '<a href="plugin-install.php?tab=search&s=WP+Nivo+Slider" target="_blank">', '</a>' ); ?>)</em></label>
<br />
...
<label class="description" for="startup_options[facebookurl]"><?php _e( 'Facebook Profile URL', 'startup' ); ?> <em>(<?php printf( __( 'example: %s', 'startup' ), '<strong>https://www.facebook.com/yourusername</strong>' ); ?>)</em></label>
<br />
...
<label class="description" for="startup_options[twitterurl]"><?php _e( 'Twitter Profile URL', 'startup' ); ?> <em>(<?php printf( __( 'example: %s', 'startup' ), '<strong>https://twitter.com/yourusername</strong>' ); ?>)</em></label>
<br />
...
<label class="description" for="startup_options[linkedinurl]"><?php _e( 'LinkedIn Profile URL', 'startup' ); ?> <em>(<?php printf( __( 'example: %s', 'startup' ), '<strong>https://www.linkedin.com/in/yourusername</strong>' ); ?>)</em></label>
<br />
...
<?php
?>
<tr valign="top"><th scope="row"><?php _e( 'Google Fonts', 'startup' ); ?><br /><em>(<?php printf( __( 'enter one google font from a %1$s selection of over six hundred %2$s, use proper capitalization and %3$s for spaces, example: %4$s.', 'startup' ), '<a href="https://www.google.com/fonts/" target="_blank">', '</a>', '<strong>+</strong>', '<strong>Open+Sans</strong>' ); printf( __( 'Then add the font name in the "Headers Font" field below or with CSS in a child theme stylesheet, example: %s', 'startup' ), '<code>h1, h2, h3, h4, h5, h6{font-family:&#39;Open Sans&#39;}</code>' ); ?>)</em></th>
<td>
